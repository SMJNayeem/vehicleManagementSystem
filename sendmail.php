...
if (isset($_POST['email'])) {
    ...
    $email_message = " This is an email form JUST Vehicle Management to confirm your vehicle. Details are given below.\n\n";
    ...
    $update_query = "UPDATE `booking` SET `confirmation`='1',`veh_reg`='$veh_reg',`driverid`='$driver_id' WHERE booking_id='$id'; UPDATE `vehicle` SET `veh_available`='1' WHERE veh_reg='$veh_reg';UPDATE `driver` SET `dr_available`='1' WHERE driverid='$driverid'";
