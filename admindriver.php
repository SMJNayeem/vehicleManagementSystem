...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="margin: 35px;">
                <a class="btn btn-info" href="newdriver.php" style="text-align: center">Add new Driver</a>
            </div>
            <div class="col-md-12">
                <div class="page-header">
                    <h1 style="text-align: center;">Driver List</h1>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><img height="70px" width="100px" src="picture/<?php echo $row["drphoto"]; ?>" alt="dp"></td>
                                <td><a class="btn btn-default" href="editdriver.php?id=<?php echo $row['driverid']; ?>">Edit</a></td>

                                <td><a class="btn btn-danger" href="deletedriver.php?id=<?php echo $row['driverid']; ?>">Delete</a></td>
    ...
    <footer style="background-color: #2f2f2f;
          color: #fff; margin-top: 80px; padding-top: 20px;
